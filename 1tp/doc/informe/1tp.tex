...
enable, uno conectado a los contadores BCD y otro conectado al contador de 
2 bits que controla los display 7 segmentos. Además se usaron cuatro contadores 
...
\end{center}
\caption{Simulación de contador BCD. Se genera un pulso de \textbf{ena} 
cada vez que la cuenta \textbf{q} pasa de 9 a 0. }
