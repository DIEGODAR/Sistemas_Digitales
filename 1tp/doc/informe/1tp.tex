...
\end{center}
\caption{Simulación de generador de enable. Genera un pulso en \textbf{q} cada 5 pulsos de clock.} 
...
\end{center}
\caption{Simulación de contador BCD. Se genera un pulso de \textbf{ena} cada vez que la cuenta \textbf{q} pasa de 9 a 0. }
...
\caption{Simulación de contador BCD de 4 dígitos, incluye el clock más los cuatro números}
